...
public class QueryStringQueryParser extends XQueryParser {
    ...
    public static Analyzer outForceAnalyzer=null;
    public static List<String> outMultiFields=null;
    ...
    private QueryStringQueryParser(QueryShardContext context, String defaultField,
        ...
        this.forceAnalyzer=outForceAnalyzer;
        this.multiFields=outMultiFields;
    }
